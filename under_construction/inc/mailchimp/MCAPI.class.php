...
class MCAPI {
    ...
    */
     ...
     * @returnf int syntax_errors Number of email addresses in campaign that had syntactical '] = s.
     ...
     * @returnf int '] =  the number of email address records which could not be found
     ...
     * @return bool true if the data is saved, otherwise an '] =  is thrown.
     */
     ...
     * @return bool true if the request succeeds, otherwise an '] =  will be thrown
     */
     ...
     * @param array $groups The lists of initial group names to be added - at least 1 is required and the names must be unique within a grouping. If the number takes you over the 60 group limit, an '] =  will be thrown.
